...
@section('content')
    <div class="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-beetwen items-center">
        ...
        <div class="flex items-center py-3 px-6 whitespace-nowrap max-w-sm bg-yellow-500 shadow-lg rounded-md border-b">
            <div class="w-10 h-10 sm:w-20 sm:h-20 rounded-full border-0 md:border-black md:border-2 md:-ml-3">
                <i class="fa-solid fa-rupiah-sign text-4xl md:text-5xl items-center md:m-4 text-black"></i>
            </div>
            <div class="pl-3">
                <div class="text-base text-black font-semibold">Keuntungan bulan ini</div>
                <div class="block font-normal text-black">Rp. 1.000.000</div>
            </div>
        </div>
    ...
    <div class="grid gap-4 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 mt-5 text-center mx-auto">
        ...
        <div class="bg-gray-100 text-black items-center shadow-lg rounded-md">
            <div class="text-center bg-yellow-500 text-black text-1xl rounded-t-md">
